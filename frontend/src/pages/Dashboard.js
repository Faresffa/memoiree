...
function Dashboard() {
  ...
  // Update Chart Data
  const updateChartDataCallback = useCallback((data) => {
    updateChartData(data);
  }, []);

// Define updateChartData function
const updateChartData = (newData) => {
  ...
  const fetchMonthlySalesData = useCallback(() => {
    fetch(`http://localhost:4000/api/sales/getmonthly`)
      .then((response) => response.json())
      .then((datas) => updateChartDataCallback(datas.salesAmount))
      .catch((err) => console.log(err));
        ...
        <article className="flex flex-col gap-4 rounded-lg border  border-gray-100 bg-white p-6  ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from 24000.94 DA </span>
            </p>
          </div>
        </article>
        ...
        <article className="flex flex-col  gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from 40000.32 DA</span>
            </p>
          </div>
        </article>
        <article className="flex flex-col   gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
