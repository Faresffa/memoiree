...
function PurchaseDetails() {
  ...
  useEffect(() => {
    // Define fetchPurchaseData inside useEffect
    ...
    // Define fetchProductsData inside useEffect
    ...
    fetchPurchaseData();
    fetchProductsData();
  }, [authContext.user]); // Add authContext.user to the dependency array
              ...
              {purchase.map((element, index) => {
                return (
                  <tr key={element._id}>
                    ...
                    <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                      {element.TotalPurchaseAmount} DA
                    </td>
                  </tr>
                );
              })}
